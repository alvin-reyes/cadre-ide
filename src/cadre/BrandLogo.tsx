 ...
 * crisp at any size and inherits theme tokens. Colors are faithful to the brand kit
 * (brand-kit/assets/carde-mark.svg); the mark is dark-first (matches the app default).
 *
...
export function BrandMark({ size = 28, className }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" fill="none" className={className} aria-hidden="true">
      <rect x="20" y="30" width="52" height="52" rx="12" fill="#5A4CE0" />
      <rect x="30" y="22" width="52" height="52" rx="12" fill="#B9B2FF" />
      <rect x="40" y="14" width="52" height="52" rx="12" fill="#FFFFFF" />
      <path d="M78 24 L52 60 L62 60 L88 24 Z" fill="#6D5EF8" />
    </svg>
  );
}
